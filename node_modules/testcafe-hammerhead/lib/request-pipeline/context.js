...
class RequestPipelineContext {
    ...
    async prepareInjectableUserScripts() {
        ...
        const injectableUserScripts = matchedUserScripts
            ...
            .map(userScript => { var _a; return ((_a = userScript) === null || _a === void 0 ? void 0 : _a.url) || ''; });
    ...
    _handleAttachment() {
        ...
        if (this.req.url) {
            ...
            isOpenedInNewWindow = ((_a = url1) === null || _a === void 0 ? void 0 : _a.windowId) !== ((_b = url2) === null || _b === void 0 ? void 0 : _b.windowId);
        }
