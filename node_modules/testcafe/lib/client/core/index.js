...
(function () {
    ...
    ***************************************************************************** */
    ...
    var KEY_PROPERTY = {
        left: browserUtils$1.isIE ? 'Left' : 'ArrowLeft',
        down: browserUtils$1.isIE ? 'Down' : 'ArrowDown',
        right: browserUtils$1.isIE ? 'Right' : 'ArrowRight',
        up: browserUtils$1.isIE ? 'Up' : 'ArrowUp',
        backspace: 'Backspace',
        capslock: 'CapsLock',
        delete: 'Delete',
        end: 'End',
        ...
        pagedown: 'PageDown',
        pageup: 'PageUp',
        space: browserUtils$1.isIE ? 'Spacebar' : ' ',
        tab: 'Tab',
        alt: 'Alt',
        ctrl: 'Control',
        meta: 'Meta',
    ...
    var KEY_MAPS = {
        ...
        symbolCharCodeToKeyCode: {
            ...
            39: 222,
            44: 188,
            45: browserUtils$1.isFirefox ? 173 : 189,
            46: 190,
            47: 191,
        },
        symbolKeysCharCodes: {
    ...
    var ScriptExecutionBarrier = /** @class */ (function () {
        ...
        ScriptExecutionBarrier.prototype._onScriptLoadedOrFailed = function (script, isTimeout) {
            ...
            if (this._scripts.size)
                return;
            delay$1(WAIT_FOR_NEW_SCRIPTS_DELAY)
                .then(function () {
    ...
    function documentReady(pageLoadTimeout) {
        ...
        return waitForDomContentLoaded()
            ...
            if (!listeners$1.getEventListeners(window, 'load').length)
                return null;
            return Promise$1.race([waitForWindowLoad(), delay$2(pageLoadTimeout)]);
        });
    }
    ...
    function wait(timeout) {
        ...
        var waitForUnloadingPromise = delay$2(timeout)
            // eslint-disable-next-line consistent-return
            .then(function () {
            if (unloading) {
        ...
        var watchdog = delay$2(MAX_UNLOADING_TIMEOUT)
            .then(function () {
            unloading = false;
        });
    ...
    var ScrollAutomation = /** @class */ (function () {
        ...
        ScrollAutomation.prototype._isTargetElementObscuredInPoint = function (point) {
            var elementInPoint = getElementFromPoint(point.x, point.y);
            if (!elementInPoint)
                return false;
    ...
    function isElementVisible$1(el) {
        ...
        if (adapter$1.dom.isSVGElement(el))
            return adapter$1.style.get(el, 'visibility') !== 'hidden' && adapter$1.style.get(el, 'display') !== 'none';
    ...
    var TEMPLATES = (_a = {},
        ...
        _a[RUNTIME_ERRORS.unsupportedUrlProtocol] = 'The "{url}" test page URL includes an unsupported {protocol}:// protocol. TestCafe only supports http://, https:// and file:// protocols.',
        ...
        _a[RUNTIME_ERRORS.cannotFindTestcafeConfigurationFile] = '"{filePath}" is not a valid path to the TestCafe configuration file. Make sure the configuration file exists and you spell the path name correctly.',
        _a);
    ...
    function getTimeLimitedPromise (promise, ms) {
        return hammerhead.Promise.race([promise, delay$2(ms).then(function () { return hammerhead.Promise.reject(new TimeLimitedPromiseTimeoutExpiredError()); })]);
    }
    ...
    // @ts-ignore
    var browser$1 = hammerhead.utils.browser;
    var initializer = { nativeMethods: hammerhead.nativeMethods, browser: browser$1, dom: domUtils, position: positionUtils, style: styleUtils$1, sendRequestToFrame: sendRequestToFrame };
