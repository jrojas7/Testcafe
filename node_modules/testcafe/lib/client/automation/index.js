...
(function () {
    function initTestCafeAutomation(window, isIFrameWithoutSrc) {
        ...
        (function (hammerhead, Promise$f, testCafeCore, testCafeUI) {
    ...
    ***************************************************************************** */
    ...
    function findElementOrNonEmptyChildFromPoint(x, y, element) {
        ...
        var isNonEmptyChild = domUtils.containsElement(element, topElement) &&
            nativeMethods$1.nodeTextContentGetter.call(topElement).length;
    ...
    function correctTopElementByExpectedElement(topElement, expectedElement) {
        ...
        var shouldSearchForMultilineLink = isLinkOrChildExpected && !isTopElementChildOfLink &&
            nativeMethods$1.nodeTextContentGetter.call(expectedElement).length;
    ...
    function getElementFromPoint(point /*: AxisValuesData<number>*/, expectedElement) {
    ...
    function nextTick () {
        return new Promise$1(function (resolve) { return nativeMethods$2.setTimeout.call(window, resolve, 0); });
    }
    ...
    var MoveBehaviour = /** @class */ (function () {
        ...
        MoveBehaviour.leaveElement = function (currentElement, prevElement, commonAncestor, options) {
            ...
            while (currentParent && currentParent !== commonAncestor) {
                ...
                currentParent = nativeMethods$3.nodeParentNodeGetter.call(currentParent);
            }
        };
    ...
    var ScrollAutomation = testCafeCore__default.ScrollAutomation;
    ...
    messageSandbox.on(messageSandbox.SERVICE_MSG_RECEIVED_EVENT, function (e) {
        if (e.message.cmd === MOVE_REQUEST_CMD) {
            if (e.source.parent === window)
                ...
                hammerhead__default.on(hammerhead__default.EVENTS.beforeUnload, function () { return messageSandbox.sendServiceMsg({ cmd: MOVE_RESPONSE_CMD }, e.source); });
    ...
    var MoveAutomation = /** @class */ (function () {
        ...
        MoveAutomation.prototype._getTargetClientPoint = function () {
            ...
            if (domUtils$1.isHtmlElement(this.element)) {
                return {
            ...
            var isDocumentBody = this.element.tagName && domUtils$1.isBodyElement(this.element);
            return {
        ...
        MoveAutomation.prototype._getEventSequenceOptions = function (currPosition) {
            var button = eventUtils.BUTTONS_PARAMETER.noButton;
        ...
        MoveAutomation.prototype._runEventSequence = function (currentElement, _a) {
            ...
            eventSequence.run(currentElement, lastHoveredElementHolder.get(), eventOptions, null, null);
        };
        ...
        MoveAutomation.prototype._movingStep = function (currPosition) {
            ...
            return cursor
                .move(currPosition)
                .then(function () { return getElementFromPoint(cursor.getPosition()); })
        ...
        MoveAutomation.prototype._move = function (endPoint) {
            var _this = this;
            var startPoint = cursor.getPosition();
            ...
            return whilst(function () { return !currPosition.eql(endPoint); }, function () {
                if (_this._needMoveCursorImmediately())
                    ...
                    var progress = Math.min((nativeMethods$4.dateNow() - startTime) / movingTime, 1);
        ...
        MoveAutomation.prototype._moveToCurrentFrame = function (endPoint) {
            ...
            var activeWindow = cursor.getActiveWindow(window);
            var iframe = null;
            ...
            if (activeWindow.parent === window) {
                iframe = domUtils$1.findIframeByWindow(activeWindow);
                var rect = positionUtils$1.getIframeClientCoordinates(iframe);
                msg.left = rect.left;
                msg.top = rect.top;
        ...
        MoveAutomation.prototype.run = function () {
            ...
            return this._scroll()
                .then(function () {
                var endPoint = _this._getTargetClientPoint();
                var _a = styleUtils.getWindowDimensions(window), windowWidth = _a.width, windowHeight = _a.height;
                ...
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        if (!isElementFocusable && !isContentEditable) {
                            ...
                            curActiveElement = nativeMethods$5.documentActiveElementGetter.call(curDocument);
    ...
    var DragMoveAutomation = /** @class */ (function (_super) {
        ...
        function DragMoveAutomation(element, moveOptions) {
            var _this = _super.call(this, element, moveOptions) || this;
    ...
    var DragAutomationBase = /** @class */ (function (_super) {
        ...
        DragAutomationBase.prototype._drag = function () {
            ...
            var moveAutomation = new DragMoveAutomation(element, dragOptions);
            return moveAutomation
                .run()
    ...
    exports$1.getElementFromPoint = getElementFromPoint;
