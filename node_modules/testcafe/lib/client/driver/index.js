...
(function () {
    function initTestCafeClientDrivers(window, isIFrameWithoutSrc) {
        ...
        (function (hammerhead, testcafeAutomation, testcafeCore, Promise$2, testcafeUi) {
    var hammerhead__default = 'default' in hammerhead ? hammerhead['default'] : hammerhead;
    Promise$2 = Promise$2 && Object.prototype.hasOwnProperty.call(Promise$2, 'default') ? Promise$2['default'] : Promise$2;
    ...
    initializeAdapter({
        ...
        scroll: function () { return hammerhead.Promise.resolve(); },
        getOffsetOptions: testcafeAutomation.getOffsetOptions,
    ...
    ***************************************************************************** */
    ...
    var ActionExecutor = /** @class */ (function (_super) {
        ...
        ActionExecutor.prototype._ensureCommandOptions = function () {
            var opts = this._command.options;
            // @ts-ignore TODO
            if (this._elements.length && opts && 'offsetX' in opts && 'offsetY' in opts) { // @ts-ignore
                var _a = adapter.getOffsetOptions(this._elements[0], opts.offsetX, opts.offsetY), offsetX = _a.offsetX, offsetY = _a.offsetY;
                // @ts-ignore TODO
        ...
        ActionExecutor.prototype.execute = function (barriers) {
            ...
            return this._runRecursively()
                .then(function () { return Promise$2.all([
    ...
    function delay$1(ms) {
        return new Promise$2(function (resolve) { return setTimeout(resolve, ms); });
    }
    ...
    var DateCtor$1 = nativeMethods$2.date;
    ...
    var Driver = /** @class */ (function (_super) {
        ...
        Driver.prototype._ensureClosedChildWindowWatcher = function () {
            ...
            if (this.checkClosedChildWindowIntervalId)
                return;
            this.checkClosedChildWindowIntervalId = nativeMethods$2.setInterval.call(window, function () {
                ...
                if (!_this.childWindowDriverLinks.length) {
                    nativeMethods$2.clearInterval.call(window, _this.checkClosedChildWindowIntervalId);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Promise$1.all(searchQueries)];
                        case 1:
        ...
        Driver.prototype._getCloseWindowFoundResult = function () {
            ...
            return Promise$1.resolve({ success: true });
        };
        ...
        Driver.prototype._closeWindow = function (msg) {
            ...
            return Promise$1.all(searchQueries);
        };
        ...
        Driver.prototype._switchToWindow = function (msg) {
            ...
            if (!this.childWindowDriverLinks.length)
                return Promise$1.resolve();
            return Promise$1.all(this.childWindowDriverLinks.map(function (childWindowDriverLink) {
        ...
        Driver.prototype._handleChildWindowIsOpenedInIFrame = function () {
            ...
            this._pendingChildWindowInIFrame = new Promise$1(function (resolve) {
        ...
        Driver.prototype._runInActiveIframe = function (command) {
            var _this = this;
            var runningChain = Promise$1.resolve();
        ...
        Driver.prototype._switchToIframe = function (selector, iframeErrorCtors) {
            ...
            return getResult(selector, commandSelectorTimeout, null, function (fn) { return new iframeErrorCtors.NotFoundError(null, fn); }, function () { return new iframeErrorCtors.IsInvisibleError(); }, this.statusBar)
                ...
                return _this._ensureChildIframeDriverLink(nativeMethods$2.contentWindowGetter.call(iframe), iframeErrorCtors.NotLoadedError, commandSelectorTimeout);
            })
        ...
        Driver.prototype._createWaitForEventPromise = function (eventName, timeout) {
            ...
            var timeoutPromise = new Promise$1(function (resolve) {
                nativeMethods$2.setTimeout.call(window, function () {
                    _this.off(eventName, eventHandler);
                    resolve();
                }, timeout);
            });
            var resultPromise = new Promise$1(function (resolve) {
            ...
            return Promise$1.race([timeoutPromise, resultPromise]);
        };
                    ...
                    switch (_a.label) {
                        case 0:
                            if (!this.contextStorage.getItem(PENDING_CHILD_WINDOW_COUNT))
                                return [2 /*return*/];
                            restoreChildWindowsPromise = new Promise$1(function (resolve) {
        ...
        Driver.prototype._onShowAssertionRetriesStatusCommand = function (command) {
            ...
            this.contextStorage.setItem(ASSERTION_RETRIES_START_TIME, nativeMethods$2.dateNow());
        ...
        Driver.prototype._closeAllChildWindows = function () {
            ...
            return Promise$1.all(this.childWindowDriverLinks.map(function (childWindowDriverLink) {
                ...
                .then(function () {
                nativeMethods$2.arrayForEach.call(_this.childWindowDriverLinks, function (childWindowDriverLink) {
        ...
        Driver.prototype._onPrepareClientEnvironmentInDebugMode = function (command) {
            ...
            nativeMethods$2.objectDefineProperty(window, command.esmRuntime, {
                value: {
                    g: window,
                    c: window.eval,
                },
    ...
    nativeMethods$3.objectDefineProperty(window, INTERNAL_PROPERTIES.testCafeDriver, { configurable: true, value: Driver });
    nativeMethods$3.objectDefineProperty(window, INTERNAL_PROPERTIES.testCafeIframeDriver, { configurable: true, value: IframeDriver });
    nativeMethods$3.objectDefineProperty(window, INTERNAL_PROPERTIES.testCafeEmbeddingUtils, { configurable: true, value: embeddingUtils });
    // eslint-disable-next-line no-undef
    hammerhead__default.on(evalIframeScript, function (e) { return initTestCafeClientDrivers(nativeMethods$3.contentWindowGetter.call(e.iframe), true); });
